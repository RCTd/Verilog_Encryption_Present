...
################################################################
# This is a generated script based on design: Present_bd
#
...
xilinx.com:user:Present_encoder:1.0\
xilinx.com:user:Present_decoder:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Present_encoder_0, and set properties
  set Present_encoder_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Present_encoder:1.0 Present_encoder_0 ]

  # Create instance: Present_decoder_0, and set properties
  set Present_decoder_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Present_decoder:1.0 Present_decoder_0 ]
  ...
  set_property CONFIG.C_IRQ_IS_LEVEL {0} $axi_intc_0
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports dual_seven_seg_led_disp] [get_bd_intf_pins axi_gpio_1/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO2 [get_bd_intf_ports seven_seg_led_an] [get_bd_intf_pins axi_gpio_1/GPIO2]
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports BTN] [get_bd_intf_pins axi_gpio_2/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins axi_gpio_2/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins axi_intc_0/s_axi]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M05_AXI [get_bd_intf_pins axi_interconnect_0/M05_AXI] [get_bd_intf_pins Present_decoder_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins axi_interconnect_0/M06_AXI] [get_bd_intf_pins Present_encoder_0/S00_AXI]
  ...
  # Create port connections
  connect_bd_net -net Present_decoder_0_interrupt [get_bd_pins Present_decoder_0/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net Present_encoder_0_interrupt [get_bd_pins Present_encoder_0/interrupt] [get_bd_pins xlconcat_0/In2]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins Present_encoder_0/s00_axi_aclk] [get_bd_pins Present_decoder_0/s00_axi_aclk]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins Present_encoder_0/s00_axi_aresetn] [get_bd_pins Present_decoder_0/s00_axi_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins axi_intc_0/intr]

  # Create address segments
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs Present_decoder_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs Present_encoder_0/S00_AXI/S00_AXI_reg] -force
